...
public class ImageAdapter extends BaseAdapter {
    ...
    public ImageAdapter(Context c,  List<Bitmap> mbitList) {
        mContext = c;
        bitList = mbitList;
        mImages = new ImageView[bitList.size()];
       }
    ...
    public boolean createReflectedImages() {
        ...
        for (int i =0;i<bitList.size();i++) {
         //返回原图解码之后的bitmap对象
         Bitmap originalImage = bitList.get(i);
...
//     return true;
    ...
    public int getCount() {
    	Log.i("====count"+mImages.length, "====count"+mImages.length);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	Log.i("====position"+position, "====position"+position);
    	Log.i("==== mImages.length"+ mImages.length, "==== mImages.length"+ mImages.length);
//    	if(position == 1){
//    		 return mImages[0];
//    	}
